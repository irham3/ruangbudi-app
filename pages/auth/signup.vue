      ...
      <form @submit.prevent="signUp" class="w-full max-w-lg" method="post">
        ...
        <div class="flex flex-wrap -mx-3 md:mb-4">
          <div class="w-full md:w-1/2 px-3">
            ...
            <select v-model="selectedClass" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
          ...
          <div class="w-full md:w-1/2 px-3">
            ...
            <select v-model="gender" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
