...
<template>
  <NuxtLayout>
    ...
    <!-- Feature Section -->
    <section
      class="flex flex-col h-screen gap-16 items-center px-20 text-center py-20 relative"
    ...
    <!-- About Section -->
    <section class="flex items-center justify-center -mt-16 gap-28 h-screen px-40 relative">
