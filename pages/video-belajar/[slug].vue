    ...
    <div class="container flex flex-row px-36 py-8 rtl:mr-3">
          ...
          <nav>
            <ul class="steps steps-vertical">
              <li data-content="✓" class="step step-primary">
                <a class="flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-md dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-800" href="#">
      ...
      <div class="ml-4">
        ...
        <iframe
          ...
          src="https://www.youtube.com/embed/QUxNzUiWvAY"
        />
      </div>
    </div>
  </NuxtLayout>
