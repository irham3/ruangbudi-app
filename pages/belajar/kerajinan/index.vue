  ...
  <NuxtLayout>
    ...
    <div class="flex flex-col px-10 md:px-36 py-8">
      ...
      <div class="mt-[11rem] md:mt-[15rem] space-y-4">
        ...
        <p class="text-center md:px-[10%]">Anak-anak sekarang memiliki banyak potensi yang dapat dikembangkan melalui berbagai kegiatan. Salah satu kegiatan yang mengasah kreativitas mereka adalah membuat kerajinan tangan.</p>
