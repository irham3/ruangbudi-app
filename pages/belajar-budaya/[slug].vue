...
<template>
  <NuxtLayout>
    <div class="px-32 flex flex-col items-center gap-10 py-16 relative">
      ...
      <div class="absolute z-[-1] w-[20rem] h-[40rem] bg-contain bg-no-repeat top-[-5rem] left-0"
        style="background-image: url('/images/background/batik.png');" />
      <div class="absolute z-[-1] w-[20rem] h-[40rem] bg-contain bg-no-repeat top-[-5rem] right-0 bg-right"
        style="background-image: url('/images/background/batik-2.png');" />
      <div class="absolute w-[20rem] h-[20rem] bg-contain bg-no-repeat bottom-0 left-0"
        style="background-image: url('/images/background/komodo.png');"> </div>
      ...
      <div class="flex px-36 gap-12 items-center">
        ...
        <div class="card w-3/4 h-64 bg-base-100 shadow-xl">
          <figure>
            <iframe class="w-full h-64" src="https://www.youtube.com/embed/kqk1k_ISx_8?si=0RE0WFmtCOmwnRu_&rel=0"
